...
export const Websites = () => {
  const websitesData = [
    ...
    },
    {
      ...
      "technologies": ["Angular", "Asp Net Core 6.0", "Bootstrap", "Mongo Db"],
      "features": ["Create new account and login", "Create tickets under the current session", "Check ticket status", "Check current inventories and filter by category", "Administration panel", "Creation and inventory control", "Ticket management", "Total control of internal users", "General system logs", "Email notifications to system users"]
    },
    {
      ...
      "technologies": ["Angular", "Spring Boot", "Bootstrap", "Mongo Db"],
      "features": ["Create new account and login", "View games in a catalog", "View user profile and edit personal information", "Purchase selected games and have a shopping cart", "General Administrative Panel", "Manage customer accounts overall", "Manage game catalogs"]
    },
    {
      ...
      "technologies": ["React Js", "Spring Boot", "React Bootstrap", "Mongo Db"],
      "features": ["Create account and login", "General personal account management", "View current fields", "Search current fields and filter by categories such as game type or location", "Creation and management of field reservations", "Manage and organize private or public tournaments"]
    },
    {
      ...
      "technologies": ["React Js", "React Bootstrap", "Spring Boot", "Mongo Db", "Render as PaaS"],
      "features": ["Create account and login", "Personal account management", "Create and view clients and search clients by name", "Create and review jobs for client's vehicles with their status as new, in progress and completed", "Creation and management of inventories", "Review diagnosis for individual clients and contact with phone or email", "Create custom quotes for clients with pdf", "General reporting"]
    }
  ];
            ...
            <Accordion.Body>
              <Card>
                <Row>
                  ...
                  <Col md={6}>
                    <Card.Body>
                      <a className="btn btn-info mt-2 mb-2" href={website.url} target="_blank" rel="noopener noreferrer">
                        Visitar Sitio
                      </a>
                      ...
                      <div>
                        {website.technologies.map((tech, i) => (
                          <Badge key={i} pill bg="info" className="me-2 mb-2">
                            {tech}
                          </Badge>
                        ))}
                      </div>
